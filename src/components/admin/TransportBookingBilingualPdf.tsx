      ...
      >
        ...
        <div className="flex justify-end mt-3">
          <div className="text-center">
            ...
            <div className="border-t border-gray-500 w-48 pt-0.5 text-[9px] text-gray-700">
        ...
        {/* Footer / Contact */}
        <div className="mt-1 pt-1 border-t border-[#C9A96E] text-center">
          <div className="text-[9px] font-bold text-[#0F4C3A]">Tuba Al Hijaz</div>
          <div className="text-[8px] text-gray-700">
            info@tubaalhijaz.com · www.tubaalhijaz.com · +880 1XXX-XXXXXX
          </div>
